...
{
    /// <summary>
    /// Service pour gérer les images des véhicules
    /// </summary>
    public class VehicleImageService
    {
        ...
        public string? SaveVehicleImage(string sourceImagePath, int vehicleId)
        {
            try
            {
                ...
                // Créer un nom de fichier unique basé sur l'ID du véhicule
                var fileName = $"vehicle_{vehicleId}_{DateTime.Now:yyyyMMddHHmmss}{extension}";
        ...
        /// </summary>
        public bool DeleteVehicleImage(string? imagePath)
        {
            try
            {
        ...
        /// </summary>
        public BitmapImage? LoadVehicleImage(string? imagePath)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(imagePath) || !File.Exists(imagePath))
