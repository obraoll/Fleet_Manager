...
('admin', '$2a$11$8Z3qN5x7Y2hWJKf.3LZxY.NwF5mVZ6p8QxN3C1K8L9mB5H7J6D4Fy', 'Jean Dupont', 'admin@fleetmanager.fr', 'Admin', TRUE, '2025-11-17 08:30:00'),
('manager', '$2a$11$8Z3qN5x7Y2hWJKf.3LZxY.NwF5mVZ6p8QxN3C1K8L9mB5H7J6D4Fy', 'Marie Martin', 'manager@fleetmanager.fr', 'Manager', TRUE, '2025-11-17 09:15:00'),
('user', '$2a$11$8Z3qN5x7Y2hWJKf.3LZxY.NwF5mVZ6p8QxN3C1K8L9mB5H7J6D4Fy', 'Pierre Bernard', 'user@fleetmanager.fr', 'User', TRUE, '2025-11-17 10:00:00'),
('technicien', '$2a$11$8Z3qN5x7Y2hWJKf.3LZxY.NwF5mVZ6p8QxN3C1K8L9mB5H7J6D4Fy', 'Sophie Dubois', 'technicien@fleetmanager.fr', 'Technicien', TRUE, '2025-11-16 14:20:00');
...
('AB-123-CD', 'Renault', 'Clio V', 2022, 'Berline', 'Essence', 45280.50, 42.00, 5.8, 'Actif', '2022-01-15', 18500.00, '2026-01-15', '2026-01-15', 'Véhicule de direction'),
('EF-456-GH', 'Peugeot', '308', 2021, 'Berline', 'Diesel', 68420.75, 50.00, 4.9, 'Actif', '2021-03-20', 22000.00, '2026-03-20', '2025-12-10', 'Véhicule commercial'),
('IJ-789-KL', 'Citroën', 'C3', 2023, 'Berline', 'Essence', 28150.00, 45.00, 6.2, 'Actif', '2023-05-10', 17800.00, '2027-05-10', '2027-05-10', NULL),
('MN-012-OP', 'Renault', 'Mégane', 2020, 'Berline', 'Diesel', 95600.25, 50.00, 5.1, 'Actif', '2020-06-18', 24500.00, '2025-12-18', '2025-12-18', 'Maintenance fréquente'),
('QR-345-ST', 'Volkswagen', 'Golf', 2021, 'Berline', 'Essence', 52340.00, 50.00, 5.5, 'Actif', '2021-09-25', 26000.00, '2026-09-25', '2026-03-15', NULL),
...
-- SUV et 4x4
('KL-890-MN', 'Dacia', 'Duster', 2022, 'SUV', 'Diesel', 58900.25, 50.00, 6.0, 'Actif', '2022-08-12', 19000.00, '2026-08-12', '2026-08-12', NULL),
('OP-123-QR', 'Nissan', 'Qashqai', 2021, 'SUV', 'Essence', 47650.50, 55.00, 6.8, 'Actif', '2021-11-05', 27500.00, '2026-11-05', '2026-05-20', 'Véhicule confort'),
('ST-456-UV', 'Renault', 'Captur', 2023, 'SUV', 'Hybride', 22100.00, 48.00, 4.5, 'Actif', '2023-01-18', 29000.00, '2027-01-18', '2027-01-18', 'Véhicule hybride économique'),

-- Camionnettes
('WX-789-YZ', 'Mercedes', 'Sprinter', 2020, 'Camionnette', 'Diesel', 125800.75, 100.00, 9.5, 'Actif', '2020-05-20', 38000.00, '2026-05-20', '2025-12-01', 'Gros porteur'),
('AB-012-CD', 'Renault', 'Master', 2021, 'Camionnette', 'Diesel', 98700.00, 95.00, 9.2, 'Actif', '2021-10-12', 35000.00, '2026-10-12', '2026-04-10', NULL),
('EF-345-GH', 'Ford', 'Transit', 2022, 'Camionnette', 'Diesel', 67500.50, 80.00, 8.8, 'Actif', '2022-06-30', 33000.00, '2026-06-30', '2026-06-30', 'Aménagement spécial'),

-- Véhicules en maintenance
('IJ-678-KL', 'Peugeot', '208', 2019, 'Berline', 'Essence', 105600.00, 40.00, 5.9, 'EnMaintenance', '2019-03-15', 16500.00, '2026-03-15', '2025-11-20', 'Révision importante en cours'),
...
-- Véhicule électrique
('QR-234-ST', 'Renault', 'Zoe', 2023, 'Berline', 'Electrique', 18500.00, 52.00, 0.0, 'Actif', '2023-09-01', 32000.00, '2027-09-01', '2027-09-01', 'Véhicule électrique - 0 émission'),

-- Véhicules inactifs
('UV-567-WX', 'Peugeot', '3008', 2018, 'SUV', 'Diesel', 142000.50, 53.00, 6.7, 'HorsService', '2018-02-10', 28000.00, '2025-11-10', '2024-08-15', 'Accident - En attente réparation'),
...
CREATE TABLE MaintenanceRecords (
    ...
    Status VARCHAR(20) DEFAULT 'Terminée',
    Notes TEXT,
    CreatedAt DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (VehicleId) REFERENCES Vehicles(VehicleId) ON DELETE CASCADE
) ENGINE=InnoDB;
...
(1, '2025-03-20', 40500.00, 'Pneumatiques', 'Changement 4 pneus été', 480.00, 'Centre Auto Express', NULL, NULL, 'Michelin Primacy 4 195/65R15 x4', 'Service montage', 'Terminée', 'Stockage pneus hiver'),
(2, '2025-10-28', 67000.00, 'Pneumatiques', 'Changement 4 pneus hiver', 520.00, 'Euromaster', NULL, NULL, 'Continental WinterContact 205/55R16 x4', 'Équipe montage', 'Terminée', NULL),
(6, '2025-09-15', 70000.00, 'Pneumatiques', 'Changement 2 pneus avant', 280.00, 'First Stop', NULL, NULL, 'Michelin Agilis 195/70R15 x2', 'Monteur pneumatiques', 'Terminée', 'Usure irrégulière'),

-- Freinage
(4, '2025-08-10', 92000.00, 'Freinage', 'Remplacement plaquettes et disques avant', 385.00, 'Garage Renault Centre', NULL, NULL, 'Plaquettes avant, Disques avant x2', 'Michel Dubois', 'Terminée', NULL),
(7, '2025-07-22', 85000.00, 'Freinage', 'Changement plaquettes arrière', 185.00, 'Garage Peugeot Sud', NULL, NULL, 'Plaquettes arrière', 'Jean Martin', 'Terminée', NULL),
(13, '2025-06-18', 120000.00, 'Freinage', 'Révision système freinage complet', 680.00, 'Garage Poids Lourds Industriel', NULL, NULL, 'Plaquettes AV/AR, Disques avant, Liquide de frein', 'Équipe mécanique PL', 'Terminée', 'Véhicule lourd'),

-- Entretien climatisation
(1, '2025-06-05', 42000.00, 'Climatisation', 'Recharge climatisation', 95.00, 'Centre Auto Express', NULL, NULL, 'Gaz R134a', 'Technicien climatisation', 'Terminée', NULL),
(5, '2025-05-20', 50000.00, 'Climatisation', 'Désinfection et recharge clim', 125.00, 'Garage Auto Service', NULL, NULL, 'Gaz R134a, Produit désinfectant', 'Service climatisation', 'Terminée', NULL),
(11, '2025-06-12', 45000.00, 'Climatisation', 'Contrôle et recharge climatisation', 110.00, 'Speedy', NULL, NULL, 'Gaz climatisation', 'Technicien agréé', 'Terminée', NULL),

-- Contrôles techniques
(2, '2025-11-08', 68000.00, 'ContrôleTechnique', 'Contrôle technique périodique', 78.00, 'Dekra Auto Contrôle', '2027-11-08', NULL, NULL, 'Contrôleur technique', 'Terminée', 'Aucune contre-visite'),
(4, '2025-10-15', 95000.00, 'ContrôleTechnique', 'Contrôle technique avec contre-visite', 128.00, 'Autosur Contrôle Technique', '2027-10-15', NULL, NULL, 'Contrôleur technique', 'Terminée', 'Défaut feux - Réparé'),
(6, '2025-09-25', 71000.00, 'ContrôleTechnique', 'Contrôle technique', 75.00, 'Dekra Auto Contrôle', '2027-09-25', NULL, NULL, 'Contrôleur technique', 'Terminée', 'Conforme'),
...
(4, '2025-05-28', 90000.00, 'Réparation', 'Remplacement alternateur', 420.00, 'Garage Renault Centre', NULL, NULL, 'Alternateur 120A', 'Michel Dubois', 'Terminée', 'Panne sur route'),
(9, '2025-07-10', 110000.00, 'Réparation', 'Remplacement courroie distribution', 680.00, 'Garage Poids Lourds Industriel', '2027-07-10', 180000.00, 'Kit distribution complet, Pompe à eau', 'Équipe mécanique PL', 'Terminée', 'Maintenance préventive'),
(7, '2025-08-05', 86500.00, 'Réparation', 'Changement batterie', 145.00, 'Centre Auto Express', NULL, NULL, 'Batterie 70Ah', 'Service rapide', 'Terminée', 'Batterie faible'),

-- Entretien carrosserie
(1, '2025-02-18', 39000.00, 'Carrosserie', 'Réparation rayure portière', 320.00, 'Carrosserie Pro', NULL, NULL, 'Peinture, Vernis', 'Carrossier', 'Terminée', 'Dommage parking'),
(11, '2025-03-25', 44000.00, 'Carrosserie', 'Remplacement pare-brise', 280.00, 'Carglass', NULL, NULL, 'Pare-brise d\'origine', 'Technicien vitrage', 'Terminée', 'Impact gravillons - Assurance'),

-- Maintenances en cours
(16, '2025-11-15', 105000.00, 'Révision', 'Révision majeure 100000 km', 850.00, 'Garage Peugeot Sud', '2026-05-15', 120000.00, 'Vidange, Filtres complets, Bougies, Courroie accessoires', 'Jean Martin', 'EnCours', 'Révision importante'),
(17, '2025-11-16', 114500.00, 'Réparation', 'Changement embrayage', 980.00, 'Garage Utilitaires Pro', '2026-02-16', 130000.00, 'Kit embrayage renforcé', 'Atelier mécanique', 'EnCours', 'Patinage embrayage'),

-- Maintenances planifiées
(5, '2025-11-25', 53000.00, 'Révision', 'Révision 50000 km programmée', 310.00, 'Garage Volkswagen', '2026-05-25', 68000.00, 'Huile, Filtres', 'Service entretien', 'Planifiée', 'Rendez-vous confirmé'),
(10, '2025-11-30', 59500.00, 'Pneumatiques', 'Changement pneus hiver', 450.00, 'Euromaster', NULL, NULL, 'Pneus hiver 215/65R16 x4', 'Monteur', 'Planifiée', 'Commande passée'),
(14, '2025-12-05', 99000.00, 'Révision', 'Révision 100000 km', 520.00, 'Garage Master Pro', '2026-06-05', 115000.00, 'Vidange, Filtres, Contrôles', 'Mécanicien spécialisé', 'Planifiée', NULL);

-- ============================================
-- 7. INDEX pour optimiser les performances
-- ============================================
CREATE INDEX idx_vehicles_status ON Vehicles(Status);
CREATE INDEX idx_vehicles_registration ON Vehicles(RegistrationNumber);
CREATE INDEX idx_fuelrecords_vehicle ON FuelRecords(VehicleId);
CREATE INDEX idx_fuelrecords_date ON FuelRecords(RefuelDate);
CREATE INDEX idx_maintenance_vehicle ON MaintenanceRecords(VehicleId);
CREATE INDEX idx_maintenance_date ON MaintenanceRecords(MaintenanceDate);
CREATE INDEX idx_assignments_vehicle ON VehicleAssignments(VehicleId);
CREATE INDEX idx_assignments_driver ON VehicleAssignments(DriverId);
CREATE INDEX idx_assignments_status ON VehicleAssignments(Status);
...
GROUP BY v.VehicleId, v.RegistrationNumber, v.Brand, v.Model, v.CurrentMileage, v.Status;
...
SELECT 
    ...
    CASE 
        WHEN mr.NextMaintenanceDate <= CURDATE() THEN 'Urgent'
        WHEN DATEDIFF(mr.NextMaintenanceDate, CURDATE()) <= 30 THEN 'Proche'
        ELSE 'Planifiée'
    END AS AlertLevel
FROM Vehicles v
...
BEGIN
    ...
    SELECT MAX(Mileage) INTO v_PreviousMileage
    FROM FuelRecords
...
BEGIN
    SELECT 
        ...
        SUM(CurrentMileage) AS TotalMileage,
        AVG(CurrentMileage) AS AverageMileage,
        (SELECT SUM(TotalCost) FROM FuelRecords) AS TotalFuelCost,
        (SELECT SUM(Cost) FROM MaintenanceRecords) AS TotalMaintenanceCost
    FROM Vehicles;
END //
...
-- Mot de passe suggéré: fleet_password_2025

-- Pour créer l'utilisateur:
-- CREATE USER 'fleet_user'@'localhost' IDENTIFIED BY 'fleet_password_2025';
...
-- FIN DU SCRIPT
-- ============================================
SELECT 'Base de données Fleet Manager créée avec succès!' AS Status;
