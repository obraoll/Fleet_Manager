...
namespace FleetManager.ViewModels
{
    public class AdvancedChartsViewModel : INotifyPropertyChanged
    {
        ...
        public AdvancedChartsViewModel(StatisticsService statisticsService, VehicleService vehicleService, ExportService exportService)
        {
        ...
        private async void ExportCharts()
        {
            try
            {
                ...
                if (saveDialog.ShowDialog() == true)
                {
                    ...
                    var (success, message) = _exportService.GenerateAdvancedPdfReport(
                        "Rapport Graphiques Avancés - Fleet Manager",
                        fleetStats,
                        vehicleStatsList,
                        saveDialog.FileName);
                    ...
                    if (success)
                    {
                        ...
                        catch { /* Ignorer si impossible d'ouvrir */ }
                    }
                    else
                    {
