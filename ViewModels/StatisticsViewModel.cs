...
namespace FleetManager.ViewModels
{
    public class StatisticsViewModel : BaseViewModel
    {
        ...
        {
            MessageBox.Show("Comparaison de périodes - En développement\n\nPériode Actuelle: " + SelectedPeriod,
                "Comparaison de Périodes", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        {
            MessageBox.Show("Paramètres d'analyse - En développement\n\n" +
                "Configuration des options d'analyse et de génération de rapports",
                "Paramètres d'Analyse", MessageBoxButton.OK, MessageBoxImage.Information);
        }
